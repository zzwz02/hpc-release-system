...
Assert-Contains "index.html" "/api/qa/status-batch"
...
Assert-Contains "index.html" "newAppDialog"
Assert-Contains "index.html" "newAppDecisionOptions"
Assert-Contains "index.html" "newAppReleaseDecision"
